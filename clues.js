...
const ELEMENTS = [
    ["H", "Hydrogen", 0, 0, 1, 0, 1, 1.008],
    ["He", "Helium", 0, 1, 1, 0, 18, 4.003],
    ["Li", "Lithium", 1, 0, 1, 0, 1, 6.94],
    ["Be", "Beryllium", 1, 0, 1, 0, 2, 9.012],
    ["B", "Boron", 0, 0, 1, 0, 13, 10.81],
    ["C", "Carbon", 0, 0, 1, 0, 14, 12.011],
    ["N", "Nitrogen", 0, 0, 1, 0, 15, 14.007],
    ["O", "Oxygen", 0, 0, 1, 0, 16, 15.999],
    ["F", "Fluorine", 0, 0, 1, 0, 17, 18.998],
    ["Ne", "Neon", 0, 1, 1, 0, 18, 20.18],
    ["Na", "Sodium", 1, 0, 1, 0, 1, 22.99],
    ["Mg", "Magnesium", 1, 0, 1, 0, 2, 24.305],
    ["Al", "Aluminium", 1, 0, 1, 0, 13, 26.982],
    ["Si", "Silicon", 0, 0, 1, 0, 14, 28.085],
    ["P", "Phosphorus", 0, 0, 1, 0, 15, 30.974],
    ["S", "Sulfur", 0, 0, 1, 0, 16, 32.06],
    ["Cl", "Chlorine", 0, 0, 1, 0, 17, 35.45],
    ["Ar", "Argon", 0, 1, 1, 0, 18, 39.948],
    ["K", "Potassium", 1, 0, 1, 0, 1, 39.098],
    ["Ca", "Calcium", 1, 0, 1, 0, 2, 40.078],
    ["Sc", "Scandium", 1, 0, 1, 0, 3, 44.956],
    ["Ti", "Titanium", 1, 0, 1, 0, 4, 47.867],
    ["V", "Vanadium", 1, 0, 1, 0, 5, 50.942],
    ["Cr", "Chromium", 1, 0, 1, 0, 6, 51.996],
    ["Mn", "Manganese", 1, 0, 1, 0, 7, 54.938],
    ["Fe", "Iron", 1, 0, 1, 0, 8, 55.845],
    ["Co", "Cobalt", 1, 0, 1, 0, 9, 58.933],
    ["Ni", "Nickel", 1, 0, 1, 0, 10, 58.693],
    ["Cu", "Copper", 1, 0, 1, 0, 11, 63.546],
    ["Zn", "Zinc", 1, 0, 1, 0, 12, 65.38],
    ["Ga", "Gallium", 1, 0, 1, 0, 13, 69.723],
    ["Ge", "Germanium", 0, 0, 1, 0, 14, 72.63],
    ["As", "Arsenic", 0, 0, 1, 0, 15, 74.922],
    ["Se", "Selenium", 0, 0, 1, 0, 16, 78.971],
    ["Br", "Bromine", 0, 0, 1, 0, 17, 79.904],
    ["Kr", "Krypton", 0, 1, 1, 0, 18, 83.798],
    ["Rb", "Rubidium", 1, 0, 1, 0, 1, 85.468],
    ["Sr", "Strontium", 1, 0, 1, 0, 2, 87.62],
    ["Y", "Yttrium", 1, 0, 1, 0, 3, 88.906],
    ["Zr", "Zirconium", 1, 0, 1, 0, 4, 91.224],
    ["Nb", "Niobium", 1, 0, 1, 0, 5, 92.906],
    ["Mo", "Molybdenum", 1, 0, 1, 0, 6, 95.95],
    ["Tc", "Technetium", 1, 0, 0, 1, 7, 98],
    ["Ru", "Ruthenium", 1, 0, 1, 0, 8, 101.07],
    ["Rh", "Rhodium", 1, 0, 1, 0, 9, 102.906],
    ["Pd", "Palladium", 1, 0, 1, 0, 10, 106.42],
    ["Ag", "Silver", 1, 0, 1, 0, 11, 107.868],
    ["Cd", "Cadmium", 1, 0, 1, 0, 12, 112.414],
    ["In", "Indium", 1, 0, 1, 0, 13, 114.818],
    ["Sn", "Tin", 1, 0, 1, 0, 14, 118.71],
    ["Sb", "Antimony", 0, 0, 1, 0, 15, 121.76],
    ["Te", "Tellurium", 0, 0, 1, 0, 16, 127.6],
    ["I", "Iodine", 0, 0, 1, 0, 17, 126.904],
    ["Xe", "Xenon", 0, 1, 1, 0, 18, 131.293],
    ["Cs", "Cesium", 1, 0, 1, 0, 1, 132.905],
    ["Ba", "Barium", 1, 0, 1, 0, 2, 137.327],
    ["La", "Lanthanum", 1, 0, 1, 0, 3, 138.905],
    ["Ce", "Cerium", 1, 0, 1, 0, 3, 140.116],
    ["Pr", "Praseodymium", 1, 0, 1, 0, 3, 140.908],
    ["Nd", "Neodymium", 1, 0, 1, 0, 3, 144.242],
    ["Pm", "Promethium", 1, 0, 0, 1, 3, 145],
    ["Sm", "Samarium", 1, 0, 1, 0, 3, 150.36],
    ["Eu", "Europium", 1, 0, 1, 0, 3, 151.964],
    ["Gd", "Gadolinium", 1, 0, 1, 0, 3, 157.25],
    ["Tb", "Terbium", 1, 0, 1, 0, 3, 158.925],
    ["Dy", "Dysprosium", 1, 0, 1, 0, 3, 162.5],
    ["Ho", "Holmium", 1, 0, 1, 0, 3, 164.93],
    ["Er", "Erbium", 1, 0, 1, 0, 3, 167.259],
    ["Tm", "Thulium", 1, 0, 1, 0, 3, 168.934],
    ["Yb", "Ytterbium", 1, 0, 1, 0, 3, 173.045],
    ["Lu", "Lutetium", 1, 0, 1, 0, 3, 174.967],
    ["Hf", "Hafnium", 1, 0, 1, 0, 4, 178.49],
    ["Ta", "Tantalum", 1, 0, 1, 0, 5, 180.948],
    ["W", "Tungsten", 1, 0, 1, 0, 6, 183.84],
    ["Re", "Rhenium", 1, 0, 1, 0, 7, 186.207],
    ["Os", "Osmium", 1, 0, 1, 0, 8, 190.23],
    ["Ir", "Iridium", 1, 0, 1, 0, 9, 192.217],
    ["Pt", "Platinum", 1, 0, 1, 0, 10, 195.084],
    ["Au", "Gold", 1, 0, 1, 0, 11, 196.967],
    ["Hg", "Mercury", 1, 0, 1, 0, 12, 200.592],
    ["Tl", "Thallium", 1, 0, 1, 0, 13, 204.38],
    ["Pb", "Lead", 1, 0, 1, 0, 14, 207.2],
    ["Bi", "Bismuth", 1, 0, 1, 0, 15, 208.98],
    ["Po", "Polonium", 1, 0, 1, 1, 16, 209],
    ["At", "Astatine", 0, 0, 1, 1, 17, 210],
    ["Rn", "Radon", 0, 1, 1, 1, 18, 222],
    ["Fr", "Francium", 1, 0, 1, 1, 1, 223],
    ["Ra", "Radium", 1, 0, 1, 1, 2, 226],
    ["Ac", "Actinium", 1, 0, 1, 1, 3, 227],
    ["Th", "Thorium", 1, 0, 1, 1, 3, 232.038],
    ["Pa", "Protactinium", 1, 0, 1, 1, 3, 231.036],
    ["U", "Uranium", 1, 0, 1, 1, 3, 238.029],
    ["Np", "Neptunium", 1, 0, 1, 1, 3, 237],
    ["Pu", "Plutonium", 1, 0, 1, 1, 3, 244],
    ["Am", "Americium", 1, 0, 0, 1, 3, 243],
    ["Cm", "Curium", 1, 0, 0, 1, 3, 247],
    ["Bk", "Berkelium", 1, 0, 0, 1, 3, 247],
    ["Cf", "Californium", 1, 0, 0, 1, 3, 251],
    ["Es", "Einsteinium", 1, 0, 0, 1, 3, 252],
    ["Fm", "Fermium", 1, 0, 0, 1, 3, 257]
];
...
atomicMassRounded: {
    name: "Atomic Mass (nearest 10)",
    cost: 1,
    category: "pink",
    fn(n) {
        return Math.round(ELEMENTS[n - 1][7] / 10) * 10;
    }
},
